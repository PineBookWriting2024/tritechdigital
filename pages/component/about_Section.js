                  ...
                  <div className="abt-con grid grid-cols-12 items-center">
                    ...
                    <div className="col-span-6">
                      <div className="abt-txt">
                        ...
                        <p className="text-[#808586]">Purus turpis vivamus sem est blandit. In at egestas id sollicitudin mattis integer aliquet ut tempor. Risus enim nisi ipsum imperdiet. Sed turpis tellus quisque tellus ipsum malesuada fringilla amet elit.</p>
                        ...
                        <div className="abt-box flex flex-1/2 pt-7">
                          <div className="abt-inner ">
                            ...
                            <p className="text-[#808586]">Purus turpis vivamus sem est blandit in at egestas.</p>
                          </div>
